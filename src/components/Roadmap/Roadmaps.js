...
function Roadmaps() {
  ...
  <div className="container px-5 py-10 mx-auto cursor-pointer">
    <div className="flex flex-wrap -m-4">
      ...
      <RoadmapCard link="https://miro.com/app/board/uXjVPDFTq3g=/?share_link_id=40239008414" img="backend.jpg" category="Web-Development" heading="Back-End Devlopment" data="Web development activities that are done at the back end of programs are referred to as back end development. Back-end development covers server-side web application logic and integration and activities, like writing APIs, creating libraries, and working with system components"/>
      <RoadmapCard link="https://drive.google.com/file/d/1NkWD4_AjzjIdLgIHxp1K1Xm5LvXJ1l4r/view?usp=sharing" img="programming.jpg" category="CP" heading="Comp-Programming" data="Competitive Programming is a mental sport which enables you to code a given problem under provided constraints. The purpose of this article is to guide every individual possessing a desire to excel in this sport. This article provides a detailed syllabus for Competitive Programming designed by industry experts to boost the preparation of the readers."/>
