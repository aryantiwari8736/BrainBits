...
function Roadmaps() {
  ...
  <div className="container px-5 py-10 mx-auto cursor-pointer">
    <div className="flex flex-wrap -m-4">
      ...
      <RoadmapCard link="https://drive.google.com/file/d/1NkWD4_AjzjIdLgIHxp1K1Xm5LvXJ1l4r/view?usp=sharing" img="backend.jpg" category="Web-Development" heading="Back-End Devlopment" data="upcoming"/>
