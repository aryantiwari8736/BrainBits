...
<div className=''>
    <p className='text-2xl text-center py-4 backgroundcard mx-4'>Web 3.0</p>
...
<div className=''>
    <p className='text-2xl text-center py-4 backgroundcard mx-4'>AI/ML</p>
...
<div className=" mx-12   p-10 ">
    <div className="border grid border-x-4 border-y-4 justify-center  backgroundcard  p-14 rounded-lg   ">
